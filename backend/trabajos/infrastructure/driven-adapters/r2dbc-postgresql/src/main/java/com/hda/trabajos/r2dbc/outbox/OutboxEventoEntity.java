 ...
 * Siempre se inserta nueva (isNew() = true, igual que SagaPasoEntity en trabajo-saga) dentro
 * de la misma transaccion que el agregado; OutboxRelay la marca publicada con un UPDATE directo
 * (OutboxEventoR2dbcRepository.marcarPublicado), nunca con save() -- volveria a intentar un
 * INSERT por el isNew() fijo. */
@Table("outbox_evento")
