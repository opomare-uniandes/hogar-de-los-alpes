package com.hda.proveedor.r2dbc.outbox;
 ...
 * Siempre se inserta nueva (isNew() = true); OutboxRelay la marca publicada con un UPDATE
 * directo (OutboxEventoR2dbcRepository.marcarPublicado), nunca con save(). */
@Table("outbox_evento")
